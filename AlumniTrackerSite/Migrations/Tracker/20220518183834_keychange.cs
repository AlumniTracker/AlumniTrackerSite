        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldofEmployment = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    AdminType = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__AlumniUs__1788CC4CE62D00D5", x => x.StudentID);
                });
